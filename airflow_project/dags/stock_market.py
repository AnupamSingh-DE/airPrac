...
def stock_market():
    ...
    def is_api_available() -> PokeReturnValue:
        ...
        url = f"{api.host}/v8/finance/chart/{SYMBOL}?metrics=high&interval=1d&range=1y"
        ...
        condition = response.json()['chart']['result'] is not None
    ...
    format_prices = DockerOperator(
        ...
        container_name = 'fromat_prices',
        api_version = 'auto',
        auto_remove = 'success',
        docker_url = 'tcp://docker-proxy:2375',
        network_mode = 'airflow-project_9336c0_airflow',
        tty = True,
        xcom_all=False,
        mount_tmp_dir=False,
        environment={
